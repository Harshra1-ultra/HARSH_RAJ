...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 18 00:55:23 2021
...
img = cv2.imread("/Users/harshraj/2.png", 1)
...
ret, thresold =cv2.threshold(img_gray,100,230,cv2.THRESH_BINARY)
...
plt.title('image histogram equlization')
